...
### Books
- **["Observability Engineering"](https://www.oreilly.com/library/view/observability-engineering/9781492076438/)** by Charity Majors, Liz Fong-Jones, George Miranda - The definitive guide to modern observability
- **["Distributed Systems Observability"](https://www.oreilly.com/library/view/distributed-systems-observability/9781492033431/)** by Cindy Sridharan - Understanding observability in complex systems

### Blogs & Articles
- [Honeycomb Blog](https://www.honeycomb.io/blog) - Modern observability best practices
- [Charity Majors' Blog](https://charity.wtf/) - Engineering leadership and observability insights
- [OpenTelemetry Documentation](https://opentelemetry.io/docs/) - Industry standard for instrumentation
- [Observability Engineering article series](https://engineering.fb.com/category/production-engineering/) - Meta's production engineering blog

### Courses & Tutorials
- [Honeycomb University](https://www.honeycomb.io/university/) - Free hands-on observability courses
- [O'Reilly: Observability for Modern Applications](https://learning.oreilly.com/) - Comprehensive video course
- [OpenTelemetry Getting Started](https://opentelemetry.io/docs/getting-started/) - Official tutorials
- [Datadog Learning Center](https://learn.datadoghq.com/) - Platform-specific observability training

### Tools Documentation
- [Honeycomb Docs](https://docs.honeycomb.io/) - Best-in-class modern observability
- [Datadog Docs](https://docs.datadoghq.com/) - Full-stack observability platform
- [Grafana Docs](https://grafana.com/docs/) - Open source observability stack
- [LangSmith Docs](https://docs.smith.langchain.com/) - LLM application observability
- [LangFuse Docs](https://langfuse.com/docs) - Open source LLM tracing

### Community
- [o11y.news](https://o11y.news/) - Weekly observability newsletter
- [r/observability](https://www.reddit.com/r/observability/) - Reddit community
- [CNCF Observability TAG](https://github.com/cncf/tag-observability) - Cloud Native Computing Foundation working group
